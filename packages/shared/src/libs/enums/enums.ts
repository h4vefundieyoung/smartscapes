export { APIErrorType } from "./api-error-type.enum.js";
...
export { CoordinatesValidationMessage } from "./coordinates-validation-message.js";
export { CoordinatesValidationRule } from "./coordinates-validation-rule.js";
